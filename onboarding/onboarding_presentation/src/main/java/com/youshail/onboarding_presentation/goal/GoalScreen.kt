package com.youshail.onboarding_presentation.goal
        ...
        Column(
            ...
            Row {
                SelectableButton(
                    ...
                    onClick = {
                        viewModel.onActivityClick(GoalType.KeepWeight)
                    },
                ...
                SelectableButton(
                    ...
                    selectedTextColor = Color.White,
                    onClick = {
                        viewModel.onActivityClick(GoalType.LoseWeight)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
                ...
                SelectableButton(
                    ...
                    selectedTextColor = Color.White,
                    onClick = {
                        viewModel.onActivityClick(GoalType.GainWeight)
                    },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
